...
function generateProductCards(products) {
    ...
    products.forEach(product => {
        ...
        // Availability status and button
        ...
        if (product.available) {
            ...
            availabilityHtml = `
                <div class="flex items-center gap-2 text-red-500 text-sm mb-3">
        ...
        card.innerHTML = `
            ...
            <div class="p-6">
                <div class="flex items-center gap-4 mb-4">
                    <img src="${product.image}" alt="Logo ${product.name}" class="w-16 h-16 rounded-lg object-contain p-1">
                    <div>
...
function setupPopup(settings) {
    ...
    if (!popup || !popupIconContainer || !popupMessage || !closePopupBtn) return;
    ...
    function showPurchasePopup() {
        ...
        popupIconContainer.innerHTML = `<img src="${randomProductObj.logo}" alt="${randomProductObj.name} logo" class="w-6 h-6 object-contain rounded-full">`;
